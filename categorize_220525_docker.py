...
dset = datasets.ImageFolder(dataset_path, transform=transforms.Compose([
	...
	while not over_flag:
		for batch_idx, (data, target) in enumerate(loader):
			...
			if g_iter % 10000 == 0:
				...
				torch.save(CL.state_dict(),'{}/clsf_{}'.format(ckpt_path,g_iter))  # args.checkpoint_dir, 'gen_{}'.format(g_iter)))
			if g_iter >= OVER_ITER:
				over_flag = True
				break
